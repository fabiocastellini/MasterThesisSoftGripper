...
int main(int argc, char **argv)
{
    ...
    ros::Publisher desired_reference_pub = public_node_handler.advertise<geometry_msgs::PoseStamped>("/joint_impedance_example_controller/desired_pose", 1);
